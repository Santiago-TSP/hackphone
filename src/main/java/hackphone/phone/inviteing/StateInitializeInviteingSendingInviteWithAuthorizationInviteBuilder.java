...
public class StateInitializeInviteingSendingInviteWithAuthorizationInviteBuilder {

    private final String pattern = "INVITE sip:662423002@asterisk.softwaremind.pl SIP/2.0\n" +
            "Via: SIP/2.0/UDP 10.5.1.208:58487;branch=z9hG4bK-524287-1---d2099b1d09428555;rport\n" +
            "Max-Forwards: 70\n" +
    ...
    public StateInitializeInviteingSendingInviteWithAuthorizationInviteBuilder() throws PeerUnavailableException {
